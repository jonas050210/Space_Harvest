...
PLAY_BINDINGS: tuple[Binding, ...] = (
    ...
    Binding("f2", "buy_clipper", "F2", "fleet", "Commission a clipper"),
    Binding("q", "buy_courser", "Q", "fleet", "Commission a courser (far-system workhorse)"),
    Binding("a", "buy_argosy", "A", "fleet", "Commission an argosy (bulk hauler)"),
    Binding("f3", "mod_greenhouse", "F3", "build", "Build a greenhouse dome"),
    Binding("f4", "mod_foundry", "F4", "build", "Build a field foundry"),
    ...
    Binding("f10", "part_icebox", "F10", "fleet", "Install an icebox hold"),
    Binding("f11", "part_sail", "F11", "fleet", "Install a solar sail"),
...
HOWTO_PAGES: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("CREWS AND TOOLS", (
        ...
        "1-4 and 0 commission hulls. F2 clipper, Q courser, A argosy.",
        "G hire miner, Z botanist, H fire.",
    )),
    ("SURFACE AND MAP", (
    ...
    ("CAMPAIGN", (
        ...
        "victory (Endless / Charter / Legacy / Worldseed) before NEW HARVEST.",
        "Ironman: one save, no mid-run loads, critical hulls can wreck.",
        "",
        "K cycles Low / Medium / High / Ultra. F1 year report. F5 save.",
        "Far Charter: Ember Shoal, L5 Garden, Hearthwreck, Night Well.",
        "The rim: Sungrazer (flare-hot helium-3), Vagrant (48 deg off the",
        "plane — coursers and barns), Boreas (the cold giant past it all).",
        "F3 greenhouse drinks ice for garden score. F4 field foundry.",
        "Worldseed victory: garden 80 + seedstock + 8,000 t.",
    )),
)
